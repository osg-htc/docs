...
-   [Binaries for RHEL8-compatible](https://repo.opensciencegrid.org/tarball-install/24-main/osg-wn-client-latest.el8.x86_64.tar.gz)
-   [Binaries for RHEL9-compatible](https://repo.opensciencegrid.org/tarball-install/24-main/osg-wn-client-latest.el9.x86_64.tar.gz)
