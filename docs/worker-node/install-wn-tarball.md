...
1.  Submit a job that executes the `env` command (e.g. Run [`condor_ce_trace`](../compute-element/troubleshoot-htcondor-ce.md#condor_ce_trace) with the `-d` flag from your HTCondor CE)
