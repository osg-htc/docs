...
1.  Submit a job that executes the `env` command (e.g. Run [condor\_ce\_trace](/compute-entrypoint/troubleshoot-htcondor-ce#condor_ce_trace) with the `-d` flag from your HTCondor CE)
