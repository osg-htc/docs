...
!!! note
    Non HTCondor batch systems may need additional configuration to support these job attributes.  See the [job router recipes](job-router-recipes.md#setting-batch-system-directives) for details on how to support them.
...
See [this section](job-router-recipes.md#how-jobs-match-to-job-routes) for details on how jobs are matched
to job routes.
