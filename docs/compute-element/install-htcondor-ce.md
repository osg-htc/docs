...
([HTCondor-CE 25](https://htcondor.com/htcondor-ce/v25/reference/)):
...
-   **File Systems**: Non-HTCondor batch systems require a
    [shared file system](https://htcondor.com/htcondor-ce/v25/configuration/local-batch-system/#sharing-the-spool-directory)
...
please refer to the [upstream documentation](https://htcondor.com/htcondor-ce/v25/configuration/local-batch-system/).
...
[upstream documentation](https://htcondor.com/htcondor-ce/v25/configuration/authentication/#scitokens).
...
-   [Configuring the Job Router](https://htcondor.com/htcondor-ce/v25/configuration/job-router-overview/)
-   [Optional configuration](https://htcondor.com/htcondor-ce/v25/configuration/optional-configuration/)
...
[upstream documentation](https://htcondor.com/htcondor-ce/v25/operation/)
...
-   [Common issues](https://htcondor.com/htcondor-ce/v25/troubleshooting/common-issues/)
-   [Debugging tools](https://htcondor.com/htcondor-ce/v25/troubleshooting/debugging-tools/)
-   [Helpful logs](https://htcondor.com/htcondor-ce/v25/troubleshooting/logs/)
