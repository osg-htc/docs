...
!!! note
    ...
    For instructions on how to get **user** certificates, see the [User Certificates document](../../security/user-certs.md).
...
- [InCommon IGTF](../../security/host-certs/incommon.md):
...
- [Let's Encrypt](../../security/host-certs/lets-encrypt.md):
...
- [DigiCert IGTF](../../security/host-certs/digicert.md):
  an IGTF-accredited CA for services that interact with the WLCG;
