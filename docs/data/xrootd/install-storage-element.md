...
1. Configure [LCMAPS authorization](../../data/xrootd/xrootd-authorization.md).
...
For more information, see [the HDFS installation documents](../../data/install-hadoop.md).
...
!!! note "See Also"
    ...
    -   [Basic GridFTP Install](../../data/gridftp.md).  Additionally covers service planning topics.
    -   [Load-balanced GridFTP Install](../../data/load-balanced-gridftp.md).  Covers the creation of
...
the [basic GridFTP install](../../data/gridftp.md).
...
For log / config file locations and system services to run, see the [basic GridFTP install](../../data/gridftp.md).
