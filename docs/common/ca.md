...
- (*default*) The OSG CA certificates. This is similar to the IGTF set, but may have a small number of additions or deletions. (See [this section](#contents-of-osg-ca-package) for details)
