...
|:------------------------------------------|:-----------|:------------------------------------------------------------------------|
| [3.5.22](/release/3.5/release-3-5-22)     | 2020-08-27 | HTCondor 8.8.10, Frontier Squid 4.13-1.1, XCache 1.5.2, gratia-probe 1.20.14, BLAHP 1.18.47, oidc-agent 3.3.3, XRootD plugins |
